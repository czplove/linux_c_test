...
//-获取html网页
void Getting_HTML_pages(char* url)
{
...
void  resume()
{
	...
	download(curlhandle , "http://software.sky-union.cn/index.asp","./index.asp",1,3);
